...
public class Room3 extends RoomFigure implements Display{
    Scanner sc=new Scanner(System.in);
    double total_price;
    final double price_per_night=3000;
    @Override
    ...
    public Room3(String Room_Type, int bed_no, int no_of_nights, int no_of_meals, String Balacony,Boolean Ac, Boolean TV,  double bed_price, double meal_price) {
        super(Room_Type, bed_no, no_of_nights,  no_of_meals, Balacony,Ac, TV, bed_price, meal_price);
    }
    
    @Override
    public double Total_Price(){
        return ((3000*no_of_nights)+(bed_no*100)+(no_of_meals*80));
    }
    @Override
